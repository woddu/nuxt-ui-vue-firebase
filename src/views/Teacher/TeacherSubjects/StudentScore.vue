...
const teacherSubject = computed(() => {
    return teacherStore.teacherSubjects()?.data.value.find(subject => 
        subject.id === router.currentRoute.value.query.teacherSubjectId
    );
})
...
<template>
    <div class="flex items-center gap-4 mb-4">
        <UButton icon="i-lucide-arrow-left" class="cursor-pointer" variant="link" size="xl" @click="router.back()"/>
        <PageHeaderTitle class="!mb-0!" :title="studentScoreModel.studentLastName + ', ' + studentScoreModel.studentFirstName + ' Scores'" />
    </div>
            ...
            <template #body>
                <div class="border-s border-default ms-3 ps-4 md:ms-5 md:ps-5">                        
                    ...
                    >
                        <template #body>
                            <div class="border-s border-default ms-3 ps-4 md:ms-5 md:ps-5">                        
                                <UFormField v-if="teacherSubject?.Exam_First !== 0" label="Exam">
            ...
            <template #body>
                <div class="border-s border-default ms-3 ps-4 md:ms-5 md:ps-5">                        
                    ...
                    >
                        <template #body>
                            <div class="border-s border-default ms-3 ps-4 md:ms-5 md:ps-5">                        
                                <UFormField v-if="teacherSubject?.Exam_Second !== 0" label="Exam">
                                    <UInputNumber v-model="studentScoreModel.Exam_Second" :min="0" :max="100" placeholder="Enter score" size="xl"/>
                                </UFormField>
                            </div>
                        </template>
                    </UAccordion>
